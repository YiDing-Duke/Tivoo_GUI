...
public class DukeBasketballEvent extends Event{
    ...
    private Calendar parseTime(Element event, String dateCategory, String timeCategory) throws ParseException{
        ...
        result.setTime(new SimpleDateFormat("MM/DD/yyyyhh:mm:ss aa").parse(combinedDateTime));
        return result;
    }
}
